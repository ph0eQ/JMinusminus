...
class JCompilationUnit extends JAST {
    ...
    public JAST analyze(Context context) {
        ...
        if(typeDeclaration instanceof JClassDeclaration){
    		...
    		if(classDec.mods.contains("public")){
    			classDec.analyze(this.context);
    		}else {
    			JAST.compilationUnit.reportSemanticError(classDec.line,
                        "Class %s requires public class of same name.", classDec.name);
    		}
    	}
        }
        return this;
