...
class JMethodDeclarationThrowable
    ...
    JVariableDeclaration statements;
    /**
    ...
    public JMethodDeclarationThrowable(int line, ArrayList<String> mods,
        String name, Type returnType,
        ArrayList<JFormalParameter> params, 
        JBlock body, JVariableDeclaration statements)
    {
        super(line);
        this.mods = mods;
        this.name = name;
