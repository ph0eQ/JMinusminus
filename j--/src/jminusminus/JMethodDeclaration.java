...
class JMethodDeclaration
    ...
    /**Throws statement parameters*/
    protected ArrayList<String> throwsStatements;
    /** Method body. */
...

    {
        ...
        this.throwsStatements = null;
    }
   /**Constructor for a JMethodDeclaration to include throws statements
    * 
    * @param line
    * @param mods
    * @param name
    ...
    * @param params
    * @param body
    * @param throwsStatements
    */
    public JMethodDeclaration(int line, ArrayList<String> mods,
            String name, Type returnType,
            ArrayList<JFormalParameter> params, JBlock body, ArrayList<String> throwsStatements)

        {
            ...
            this.isStatic = mods.contains("static");
            this.isPrivate = mods.contains("private");
            this.throwsStatements = throwsStatements;
        }
    ...
    public void writeToStdOut(PrettyPrinter p) {
        ...
        if (throwsStatements != null) {
            p.println("<ThrowsStatement>");
            p.indentRight();
            for (String mod : throwsStatements) {
                p.printf("<Throws name=\"%s\"/>\n", mod);
            }
            p.indentLeft();
            p.println("</ThrowsStatement>");
        }
