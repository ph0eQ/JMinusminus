...
class JDoWhileStatement extends JStatement {
    ...
    public void codegen(CLEmitter output) {
    	...
    	//generate label for top of body block
    	output.addLabel(top);
    	//output code for body
    	body.codegen(output);
    	//generate code for exiting do body from while 
    	condition.codegen(output, out, false);
    	//unconditional jump back to top of do block
    	output.addBranchInstruction(GOTO, top);
    	//add the label outside loop
    	output.addLabel(out);
