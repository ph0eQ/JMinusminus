...
class JRShiftOp extends JBinaryExpression {
    ...
    /**
     * Construct an AST for a >> expression given its line number,
     * and the lhs and rhs operands.
     * 
     * @param line
     *            line in which the multiplication expression occurs in the
...
class JURShiftOp extends JBinaryExpression {
     ...
     * 
     * @param line
     *            line in which the >>> expression occurs in the
     *            source file.
     * @param lhs
     *            the lhs operand.
     * @param rhs
...
/**
 * The AST node for a binary OR (|) expression.
 */

class JBOrOp extends JBinaryExpression {

    /**
     * Construct an AST for a binary OR expression given its line number,
     * and the lhs and rhs operands.
     * 
     * @param line
     *            line in which the multiplication expression occurs in the
...
/**
 * The AST node for a binary AND (&) expression.
 */
...
/**
 * The AST node for a binary XOR (^) expression.
 */
