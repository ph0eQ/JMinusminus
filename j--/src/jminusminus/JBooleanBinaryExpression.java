...
class JLogicalOrOp extends JBooleanBinaryExpression {
    ...
    /**
     * Construct an AST node for a logical || expression given its line number,
     * and lhs and rhs operands.
     * 
     * @param line
     *            line in which the logical || expression occurs in the source
     *            file.
     * @param lhs
     *            lhs operand.
     * @param rhs
...
/**
 * The AST node for a not equal (!=) expression. Implements short-circuiting
 * branching.
 */
