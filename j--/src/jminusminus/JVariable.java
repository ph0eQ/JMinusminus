    ...
    public JExpression analyze(Context context) {
        ...
        if (iDefn == null) {
            ...
            if (field == null) {
             ...
             //   int offset = 0;
              //  if(iDefn instanceof LocalVariableDefn){
               // 	offset = ((LocalVariableDefn) iDefn).offset();
                	
              //  }
                //creates new local variable at current offset with Type.Any
                //this will reduce the superflous errors that will occur if type not defined
                
            	iDefn = new LocalVariableDefn(Type.ANY, 0);
            ...
            if (!analyzeLhs && iDefn instanceof LocalVariableDefn
            	...
            	//iDefn = new LocalVariableDefn(Type.ANY,(LocalVariableDefn iDefn)offset);
